...
let proxyUrl: string = process.env["agent.proxyurl"];
...
var httpCallbackClient = new httpClient.HttpClient(process.env["USER_AGENT"] || "TYPED_AZURE_REST_AGENT", null, requestOptions);
